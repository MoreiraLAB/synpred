...
from synpred_variables import DATASET_FOLDER, INTERMEDIATE_SEP, \
                                SYSTEM_SEP, CSV_SEP
...
if problem_type == "classification":
    ...
    classification_model, train_class, train_predictions = model_training(train, \
                                                        ...
                                                        save_model = False, problem_type = problem_type)

    names, test, target = prepare_dataset(file = test, method = method, task_type = "classification")
    ...
    names, test, target = prepare_dataset(file = test, method = method, task_type = "regression")
